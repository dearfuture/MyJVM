...
class ClassFile:
    ...
    def __init__(self):
        ...
        self.source_file_attribute = None
    ...
    def get_source_file(self):
        if self.source_file_attribute is None:
            for attr_info in self.attributes:
                if attr_info.attr_name == "SourceFile":
                    self.source_file_attribute = attr_info

        if self.source_file_attribute is not None:
            return self.source_file_attribute.file_name
        else:
            return "Unknown"