...
def lookup_method(clazz, name: str, descriptor: str):
...
def lookup_interface_method(clazz, name: str, descriptor: str):
    return lookup_method_in_class(clazz, name, descriptor)

def lookup_method_in_class(clazz, name: str, descriptor: str):
    c = clazz
    while c is not None:
...
def lookup_method_in_interfaces(clazz, name: str, descriptor: str, search_self = True):
    if search_self:
